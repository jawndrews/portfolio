    ...
    const animate = () => {
      ...
      shapes.forEach((shape) => {
        ...
        shape.position.x =
          ...
          Math.sin(time + userData.phase) *
            userData.movementRange.x *
            userData.movementSpeed.x;
        shape.position.y =
          userData.initialPosition.y +
          Math.cos(time + userData.phase) *
            userData.movementRange.y *
            userData.movementSpeed.y;
      });
